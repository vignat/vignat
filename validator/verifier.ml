...
let verify_file fname outf =
  let _ = Sys.command ("~/proj/verifast-1757/bin/verifast -c -I ../nat " ^ fname ^ " > " ^ outf)
  in
...
let export_assumptions src_file export_point assu_file lino_fname outf =
