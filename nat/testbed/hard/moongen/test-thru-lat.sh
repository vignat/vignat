...
touch $RESULT_FILE
for flows in 1000 10000 20000 30000 40000 50000 60000 65000; do #1 10
	sudo $MOONGEN_PATH/build/MoonGen ~/scripts/moongen/l3-load-latency.lua 1 0 --flows $flows --timeout $TIMEOUT
