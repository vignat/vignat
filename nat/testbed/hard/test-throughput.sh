...
# Measure the maximum throughput of various middleboxes in
# the loopback scenario depending on the number of concurrent flows.
...
TEST_FILE="$HOME/scripts/pktgen-scripts/regular-with-bin-mf.lua"
