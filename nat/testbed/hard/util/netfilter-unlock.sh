...
echo 83886080 | sudo tee /proc/sys/net/core/wmem_default

# 16KB receive buffer, 20,480 connections max at worst case
echo 335544320 | sudo tee /proc/sys/net/core/rmem_max
echo 335544320 | sudo tee /proc/sys/net/core/rmem_default
...
echo 15 | sudo tee /proc/sys/net/ipv4/tcp_fin_timeout

# SYN backlog increased
echo 65536 | sudo tee /proc/sys/net/ipv4/tcp_max_syn_backlog
