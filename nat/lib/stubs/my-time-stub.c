...
void start_time_control(void) {
    starting_time = klee_int("starting_time");
    last_time = starting_time;
}
void start_time(void) {start_time_control();}
...
uint32_t get_start_time_control(void) {
    return starting_time;
}
uint32_t get_start_time(void) {return get_start_time_control();}
